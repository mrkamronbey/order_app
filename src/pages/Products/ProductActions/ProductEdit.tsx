...
export const ProductEdit: React.FC<ProductAddProps> = ({ open, setOpen, productId, onProductCreated }) => {
  const {
    control,
    handleSubmit,
    handleEditClose,
    ...
    errors,
    setOpenMessage,
  } = useProductForm(productId, setOpen, onProductCreated)
      ...
      <Modal open={open} setOpen={setOpen} width={1000}>
        <Box component="form" onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid size={3}>
              <Button fullWidth variant="outlined" size="large" color="warning" onClick={handleEditClose}>
                Close
              </Button>
            </Grid>
          </Grid>
