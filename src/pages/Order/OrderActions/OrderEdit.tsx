...
export const OrderEdit: React.FC<OrderEditFormProps> = ({ open, setOpen, onOrderCreated, orderId }) => {
  const {
    control,
    handleSubmit,
    register,
    ...
    setOpenMessage,
    onSubmit,
  } = useOrderForm(orderId, onOrderCreated, setOpen) // Pass orderId for edit
  ...
  return (
    <>
      <Message
        ...
        message={errorMessage ? errorMessage : 'Order updated successfully'}
      ...
      <Modal open={open} setOpen={setOpen} width={1000}>
        ...
        <Box component="form" onSubmit={handleSubmit(onSubmit)} noValidate autoComplete="off">
          ...
          <Grid container spacing={2} mt={4}>
            ...
            <Grid size={3}>
              <Button type="button" variant="outlined" size="large" color="warning" fullWidth onClick={handleEditClose}>
                Close
              </Button>
            </Grid>
          </Grid>
